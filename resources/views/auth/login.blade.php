            ...
            @csrf
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  ...
				  <input type="text" id="email" class="form-control form-control-rounded  @error('email') is-invalid @enderror" name="email" placeholder="Email" required>
         ...
         @enderror
			  ...
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  ...
				  <input type="password" id="password" class="form-control form-control-rounded @error('password') is-invalid @enderror" name="password" placeholder="Password" required>
				  <div class="form-control-position">
					  <i class="icon-lock"></i>
          </div>
          @error('password')
