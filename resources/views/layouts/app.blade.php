...
<head>
  ...
  <script src="{{ asset('assets/plugins/bootstrap-datatable/js/jquery.dataTables.min.js')}}" defer></script>
  <script src="{{ asset('assets/plugins/bootstrap-datatable/js/dataTables.bootstrap4.min.js')}}" defer></script>
  <script src="{{ asset('assets/plugins/bootstrap-datatable/js/dataTables.buttons.min.js')}}" defer></script>
	 ...
	 <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="/agents" class="waves-effect">
          <i class="icon-user"></i> <span>Agents</span>
        </a>
      </li>
      <li>
        ...
        <ul class="sidebar-submenu">
  		  <li><a href="ui-typography.html"><i class="fa fa-circle-o"></i>Reports By Date</a></li>
  		  <li><a href="ui-buttons.html"><i class="fa fa-circle-o"></i>Reports By Agent</a></li>
        </ul>
      </li>
